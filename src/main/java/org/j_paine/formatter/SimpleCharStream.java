...
/*     */   
/*  32 */   protected void setTabSize(int paramInt) { this.tabSize = paramInt; }
/*  33 */   protected int getTabSize(int paramInt) { return this.tabSize; }
/*     */   
/*     */ 
...
/*     */     {
/*  77 */       throw new Error(localThrowable.getMessage());
/*     */     }
/*     */     
/*     */ 
...
/*     */     }
/*     */     
/* 408 */     int k = 0;int m = 0;int n = 0;
/* 409 */     int i1 = 0;int i2 = 0;
/*     */     
/*     */ 
/* 412 */     while ((k < j) && (this.bufline[(m = i % this.bufsize)] == this.bufline[(n = ++i % this.bufsize)]))
/*     */     {
/* 414 */       this.bufline[m] = paramInt1;
/* 415 */       i1 = i2 + this.bufcolumn[n] - this.bufcolumn[m];
/* 416 */       this.bufcolumn[m] = (paramInt2 + i2);
/* 417 */       i2 = i1;
/* 418 */       k++;
/*     */     }
/*     */     
/* 421 */     if (k < j)
/*     */     {
/* 423 */       this.bufline[m] = (paramInt1++);
/* 424 */       this.bufcolumn[m] = (paramInt2 + i2);
/*     */       
/* 426 */       while (k++ < j)
/*     */       {
/* 428 */         if (this.bufline[(m = i % this.bufsize)] != this.bufline[(++i % this.bufsize)]) {
/* 429 */           this.bufline[m] = (paramInt1++);
/*     */         } else {
/* 431 */           this.bufline[m] = paramInt1;
/*     */         }
/*     */       }
/*     */     }
/* 435 */     this.line = this.bufline[m];
/* 436 */     this.column = this.bufcolumn[m];
/*     */   }
/*     */ }


/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/j_paine/formatter/SimpleCharStream.class
