...
public final class Dnaupd
{
  ...
  public static void dnaupd(intW paramintW1, String paramString1, int paramInt1, String paramString2, int paramInt2, doubleW paramdoubleW, double[] paramArrayOfDouble1, int paramInt3, int paramInt4, double[] paramArrayOfDouble2, int paramInt5, int paramInt6, int[] paramArrayOfInt1, int paramInt7, int[] paramArrayOfInt2, int paramInt8, double[] paramArrayOfDouble3, int paramInt9, double[] paramArrayOfDouble4, int paramInt10, int paramInt11, intW paramintW2)
  {
    ...
    if ((paramintW1.val != 0 ? 0 : 1) != 0)
    {
      ...
      else
      {
        ...
        if ((paramdoubleW.val > 0.0D ? 0 : 1) != 0) {
          paramdoubleW.val = Dlamch.dlamch("EpsMach");
        }
    ...
    {
      Dnaup2.dnaup2(paramintW1, paramString1, paramInt1, paramString2, nev0, np, paramdoubleW.val, paramArrayOfDouble1, paramInt3, mode, iupd, ishift, mxiter, paramArrayOfDouble2, paramInt5, paramInt6, paramArrayOfDouble4, ih - 1 + paramInt10, ldh, paramArrayOfDouble4, ritzr - 1 + paramInt10, paramArrayOfDouble4, ritzi - 1 + paramInt10, paramArrayOfDouble4, bounds - 1 + paramInt10, paramArrayOfDouble4, iq - 1 + paramInt10, ldq, paramArrayOfDouble4, iw - 1 + paramInt10, paramArrayOfInt2, paramInt8, paramArrayOfDouble3, paramInt9, paramintW2);
      ...
      if ((paramintW1.val == 99 ? 0 : 1) == 0)
      {
        ...
        if ((paramintW2.val >= 0 ? 0 : 1) == 0)
        {
          ...
          if ((msglvl <= 0 ? 0 : 1) != 0)
          {
            ...
            Dvout.dvout(arpack_debug.logfil.val, np.val, paramArrayOfDouble4, ritzr - 1 + paramInt10, arpack_debug.ndigit.val, "_naupd: Real part of the final Ritz values");
            Dvout.dvout(arpack_debug.logfil.val, np.val, paramArrayOfDouble4, ritzi - 1 + paramInt10, arpack_debug.ndigit.val, "_naupd: Imaginary part of the final Ritz values");
            Dvout.dvout(arpack_debug.logfil.val, np.val, paramArrayOfDouble4, bounds - 1 + paramInt10, arpack_debug.ndigit.val, "_naupd: Associated Ritz estimates");
          }
          Second.second(t1);
          t1.val -= t0.val;
          if ((msglvl <= 0 ? 0 : 1) != 0)
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/arpack/Dnaupd.class
