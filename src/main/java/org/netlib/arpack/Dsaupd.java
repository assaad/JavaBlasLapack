  ...
  public static void dsaupd(intW paramintW1, String paramString1, int paramInt1, String paramString2, int paramInt2, doubleW paramdoubleW, double[] paramArrayOfDouble1, int paramInt3, int paramInt4, double[] paramArrayOfDouble2, int paramInt5, int paramInt6, int[] paramArrayOfInt1, int paramInt7, int[] paramArrayOfInt2, int paramInt8, double[] paramArrayOfDouble3, int paramInt9, double[] paramArrayOfDouble4, int paramInt10, int paramInt11, intW paramintW2)
  {
    ...
    if ((paramintW1.val != 0 ? 0 : 1) != 0)
    {
      ...
      else
      {
        ...
        {
          paramArrayOfDouble4[(i - 1 + paramInt10)] = 0.0D;
          i += 1;
        }
        ldh = paramInt4;
        ldq = paramInt4;
    ...
    {
      Dsaup2.dsaup2(paramintW1, paramString1, paramInt1, paramString2, nev0, np, paramdoubleW.val, paramArrayOfDouble1, paramInt3, mode, iupd, ishift, mxiter, paramArrayOfDouble2, paramInt5, paramInt6, paramArrayOfDouble4, ih - 1 + paramInt10, ldh, paramArrayOfDouble4, ritz - 1 + paramInt10, paramArrayOfDouble4, bounds - 1 + paramInt10, paramArrayOfDouble4, iq - 1 + paramInt10, ldq, paramArrayOfDouble4, iw - 1 + paramInt10, paramArrayOfInt2, paramInt8, paramArrayOfDouble3, paramInt9, paramintW2);
      ...
      if ((paramintW1.val == 99 ? 0 : 1) == 0)
      {
        ...
        if ((paramintW2.val >= 0 ? 0 : 1) == 0)
        {
          ...
          if ((msglvl <= 0 ? 0 : 1) != 0)
          {
            ...
            Dvout.dvout(arpack_debug.logfil.val, np.val, paramArrayOfDouble4, ritz - 1 + paramInt10, arpack_debug.ndigit.val, "_saupd: final Ritz values");
            Dvout.dvout(arpack_debug.logfil.val, np.val, paramArrayOfDouble4, bounds - 1 + paramInt10, arpack_debug.ndigit.val, "_saupd: corresponding error bounds");
          }
          Second.second(t1);
          t1.val -= t0.val;
          if ((msglvl <= 0 ? 0 : 1) != 0)
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/arpack/Dsaupd.class
