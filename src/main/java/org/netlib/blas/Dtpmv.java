...
{
  public static void dtpmv(String paramString1, String paramString2, String paramString3, int paramInt1, double[] paramArrayOfDouble1, int paramInt2, double[] paramArrayOfDouble2, int paramInt3, int paramInt4)
  {
    double d = 0.0D;
    int i = 0;
    int j = 0;
        ...
        if ((paramInt4 != 1 ? 0 : 1) != 0)
        {
          ...
          for (i4 = paramInt1 - 1 + 1; i4 > 0; i4--)
          {
            if ((paramArrayOfDouble2[(m - 1 + paramInt3)] == 0.0D ? 0 : 1) != 0)
            {
              ...
              if (bool) {
                paramArrayOfDouble2[(m - 1 + paramInt3)] *= paramArrayOfDouble1[(i2 + m - 1 - 1 + paramInt2)];
              }
            }
            i2 += m;
            m += 1;
        ...
        else
        {
          ...
          for (i4 = paramInt1 - 1 + 1; i4 > 0; i4--)
          {
            if ((paramArrayOfDouble2[(n - 1 + paramInt3)] == 0.0D ? 0 : 1) != 0)
            {
              ...
              if (bool) {
                paramArrayOfDouble2[(n - 1 + paramInt3)] *= paramArrayOfDouble1[(i2 + m - 1 - 1 + paramInt2)];
              }
            }
            n += paramInt4;
            i2 += m;
        ...
        if ((paramInt4 != 1 ? 0 : 1) != 0)
        {
          ...
          for (i4 = (1 - paramInt1 + -1) / -1; i4 > 0; i4--)
          {
            if ((paramArrayOfDouble2[(m - 1 + paramInt3)] == 0.0D ? 0 : 1) != 0)
            {
              ...
              if (bool) {
                paramArrayOfDouble2[(m - 1 + paramInt3)] *= paramArrayOfDouble1[(i2 - paramInt1 + m - 1 + paramInt2)];
              }
            }
            i2 -= paramInt1 - m + 1;
            m += -1;
        ...
        else
        {
          ...
          for (i4 = (1 - paramInt1 + -1) / -1; i4 > 0; i4--)
          {
            if ((paramArrayOfDouble2[(n - 1 + paramInt3)] == 0.0D ? 0 : 1) != 0)
            {
              ...
              if (bool) {
                paramArrayOfDouble2[(n - 1 + paramInt3)] *= paramArrayOfDouble1[(i2 - paramInt1 + m - 1 + paramInt2)];
              }
            }
            n -= paramInt4;
            i2 -= paramInt1 - m + 1;
    ...
    else if (Lsame.lsame(paramString1, "U"))
    {
      ...
      if ((paramInt4 != 1 ? 0 : 1) != 0)
      {
        ...
        for (i4 = (1 - paramInt1 + -1) / -1; i4 > 0; i4--)
        {
          d = paramArrayOfDouble2[(m - 1 + paramInt3)];
          if (bool) {
            d *= paramArrayOfDouble1[(i2 - 1 + paramInt2)];
          }
          i1 = i2 - 1;
          i = m - 1;
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/blas/Dtpmv.class
