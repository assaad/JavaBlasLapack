...
public final class Stpmv
{
  public static void stpmv(String paramString1, String paramString2, String paramString3, int paramInt1, float[] paramArrayOfFloat1, int paramInt2, float[] paramArrayOfFloat2, int paramInt3, int paramInt4)
  {
    float f = 0.0F;
    int i = 0;
    int j = 0;
        ...
        if ((paramInt4 != 1 ? 0 : 1) != 0)
        {
          ...
          for (i4 = paramInt1 - 1 + 1; i4 > 0; i4--)
          {
            if ((paramArrayOfFloat2[(m - 1 + paramInt3)] == 0.0F ? 0 : 1) != 0)
            {
              ...
              if (bool) {
                paramArrayOfFloat2[(m - 1 + paramInt3)] *= paramArrayOfFloat1[(i2 + m - 1 - 1 + paramInt2)];
              }
            }
            i2 += m;
            m += 1;
        ...
        else
        {
          ...
          for (i4 = paramInt1 - 1 + 1; i4 > 0; i4--)
          {
            if ((paramArrayOfFloat2[(n - 1 + paramInt3)] == 0.0F ? 0 : 1) != 0)
            {
              ...
              if (bool) {
                paramArrayOfFloat2[(n - 1 + paramInt3)] *= paramArrayOfFloat1[(i2 + m - 1 - 1 + paramInt2)];
              }
            }
            n += paramInt4;
            i2 += m;
        ...
        if ((paramInt4 != 1 ? 0 : 1) != 0)
        {
          ...
          for (i4 = (1 - paramInt1 + -1) / -1; i4 > 0; i4--)
          {
            if ((paramArrayOfFloat2[(m - 1 + paramInt3)] == 0.0F ? 0 : 1) != 0)
            {
              ...
              if (bool) {
                paramArrayOfFloat2[(m - 1 + paramInt3)] *= paramArrayOfFloat1[(i2 - paramInt1 + m - 1 + paramInt2)];
              }
            }
            i2 -= paramInt1 - m + 1;
            m += -1;
        ...
        else
        {
          ...
          for (i4 = (1 - paramInt1 + -1) / -1; i4 > 0; i4--)
          {
            if ((paramArrayOfFloat2[(n - 1 + paramInt3)] == 0.0F ? 0 : 1) != 0)
            {
              ...
              if (bool) {
                paramArrayOfFloat2[(n - 1 + paramInt3)] *= paramArrayOfFloat1[(i2 - paramInt1 + m - 1 + paramInt2)];
              }
            }
            n -= paramInt4;
            i2 -= paramInt1 - m + 1;
    ...
    else if (Lsame.lsame(paramString1, "U"))
    {
      ...
      if ((paramInt4 != 1 ? 0 : 1) != 0)
      {
        ...
        for (i4 = (1 - paramInt1 + -1) / -1; i4 > 0; i4--)
        {
          f = paramArrayOfFloat2[(m - 1 + paramInt3)];
          if (bool) {
            f *= paramArrayOfFloat1[(i2 - 1 + paramInt2)];
          }
          i1 = i2 - 1;
          i = m - 1;
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/blas/Stpmv.class
