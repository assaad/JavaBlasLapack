...
public final class Strmm
{
  public static void strmm(String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2, float paramFloat, float[] paramArrayOfFloat1, int paramInt3, int paramInt4, float[] paramArrayOfFloat2, int paramInt5, int paramInt6)
  {
    float f = 0.0F;
    int i = 0;
    int j = 0;
    ...
    if (bool1)
    {
        ...
        if (bool3)
        {
          ...
          for (i1 = paramInt2 - 1 + 1; i1 > 0; i1--)
          {
            ...
            for (i2 = paramInt1 - 1 + 1; i2 > 0; i2--)
            {
              ...
              {
                f = paramFloat * paramArrayOfFloat2[(m - 1 + (k - 1) * paramInt6 + paramInt5)];
                i = 1;
                ...
                if (bool2) {
                  f *= paramArrayOfFloat1[(m - 1 + (m - 1) * paramInt4 + paramInt3)];
                }
                paramArrayOfFloat2[(m - 1 + (k - 1) * paramInt6 + paramInt5)] = f;
              }
              m += 1;
            }
            k += 1;
      ...
      else if (bool3)
      {
        ...
        for (i1 = paramInt2 - 1 + 1; i1 > 0; i1--)
        {
          ...
          for (i2 = (1 - paramInt1 + -1) / -1; i2 > 0; i2--)
          {
            f = paramArrayOfFloat2[(i - 1 + (k - 1) * paramInt6 + paramInt5)];
            if (bool2) {
            ...
            paramArrayOfFloat2[(i - 1 + (k - 1) * paramInt6 + paramInt5)] = (paramFloat * f);
            i += -1;
          }
          k += 1;
        }
    ...
    else if (Lsame.lsame(paramString3, "N"))
    {
      if (bool3)
      {
        ...
        for (i1 = (1 - paramInt2 + -1) / -1; i1 > 0; i1--)
        {
          f = paramFloat;
          if (bool2) {
            f *= paramArrayOfFloat1[(k - 1 + (k - 1) * paramInt4 + paramInt3)];
          }
          i = 1;
          for (i2 = paramInt1 - 1 + 1; i2 > 0; i2--)
          {
          ...
          for (i2 = k - 1 - 1 + 1; i2 > 0; i2--)
          {
            ...
            {
              f = paramFloat * paramArrayOfFloat1[(m - 1 + (k - 1) * paramInt4 + paramInt3)];
              i = 1;
    ...
    else if (bool3)
    {
      ...
      for (i1 = paramInt2 - 1 + 1; i1 > 0; i1--)
      {
        ...
        for (i2 = m - 1 - 1 + 1; i2 > 0; i2--)
        {
          ...
          {
            f = paramFloat * paramArrayOfFloat1[(k - 1 + (m - 1) * paramInt4 + paramInt3)];
            i = 1;
            for (i3 = paramInt1 - 1 + 1; i3 > 0; i3--)
            {
              paramArrayOfFloat2[(i - 1 + (k - 1) * paramInt6 + paramInt5)] += f * paramArrayOfFloat2[(i - 1 + (m - 1) * paramInt6 + paramInt5)];
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/blas/Strmm.class
