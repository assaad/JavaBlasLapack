...
{
  public static void dgeqr2(int paramInt1, int paramInt2, double[] paramArrayOfDouble1, int paramInt3, int paramInt4, double[] paramArrayOfDouble2, int paramInt5, double[] paramArrayOfDouble3, int paramInt6, intW paramintW)
  {
    int i = 0;
    int j = 0;
    double d = 0.0D;
    ...
    {
      Xerbla.xerbla("DGEQR2", -paramintW.val);
      return;
    }
    ...
    for (int k = j - 1 + 1; k > 0; k--)
    {
      ...
      if ((i >= paramInt2 ? 0 : 1) != 0)
      {
        ...
        Dlarf.dlarf("Left", paramInt1 - i + 1, paramInt2 - i, paramArrayOfDouble1, i - 1 + (i - 1) * paramInt4 + paramInt3, 1, paramArrayOfDouble2[(i - 1 + paramInt5)], paramArrayOfDouble1, i - 1 + (i + 1 - 1) * paramInt4 + paramInt3, paramInt4, paramArrayOfDouble3, paramInt6);
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/lapack/Dgeqr2.class
