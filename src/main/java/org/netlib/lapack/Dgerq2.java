...
{
  public static void dgerq2(int paramInt1, int paramInt2, double[] paramArrayOfDouble1, int paramInt3, int paramInt4, double[] paramArrayOfDouble2, int paramInt5, double[] paramArrayOfDouble3, int paramInt6, intW paramintW)
  {
    int i = 0;
    int j = 0;
    double d = 0.0D;
    ...
    {
      Xerbla.xerbla("DGERQ2", -paramintW.val);
      return;
    }
    ...
    {
      dlarfg_adapter(paramInt2 - j + i, paramArrayOfDouble1, paramInt1 - j + i - 1 + (paramInt2 - j + i - 1) * paramInt4 + paramInt3, paramArrayOfDouble1, paramInt1 - j + i - 1 + (1 - 1) * paramInt4 + paramInt3, paramInt4, paramArrayOfDouble2, i - 1 + paramInt5);
      ...
      Dlarf.dlarf("Right", paramInt1 - j + i - 1, paramInt2 - j + i, paramArrayOfDouble1, paramInt1 - j + i - 1 + (1 - 1) * paramInt4 + paramInt3, paramInt4, paramArrayOfDouble2[(i - 1 + paramInt5)], paramArrayOfDouble1, paramInt3, paramInt4, paramArrayOfDouble3, paramInt6);
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/lapack/Dgerq2.class
