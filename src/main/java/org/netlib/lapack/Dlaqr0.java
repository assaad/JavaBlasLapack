...
{
  public static void dlaqr0(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, int paramInt3, double[] paramArrayOfDouble1, int paramInt4, int paramInt5, double[] paramArrayOfDouble2, int paramInt6, double[] paramArrayOfDouble3, int paramInt7, int paramInt8, int paramInt9, double[] paramArrayOfDouble4, int paramInt10, int paramInt11, double[] paramArrayOfDouble5, int paramInt12, int paramInt13, intW paramintW)
  {
    ...
    else
    {
      ...
      i16 = Ilaenv.ilaenv(12, "DLAQR0", str, paramInt1, paramInt2, paramInt3, paramInt13);
      i16 = Math.max(11, i16);
      i15 = Ilaenv.ilaenv(14, "DLAQR0", str, paramInt1, paramInt2, paramInt3, paramInt13);
      i15 = Math.max(0, i15);
      n = Ilaenv.ilaenv(16, "DLAQR0", str, paramInt1, paramInt2, paramInt3, paramInt13);
      n = Math.max(0, n);
      n = Math.min(2, n);
        ...
        if ((((i1 - i5 + 1 <= Math.min(i16, i22) ? 0 : 1) != 0 ? 1 : 0) == 0 ? 0 : 1) != 0)
        {
          ...
          else
          {
            if ((i1 - i3 + 1 > i17 / 2 ? 0 : 1) != 0)
            {
              ...
              if ((i17 <= i16 ? 0 : 1) != 0) {
                Dlaqr4.dlaqr4(false, false, i17, 1, i17, paramArrayOfDouble1, i4 - 1 + (1 - 1) * paramInt5 + paramInt4, paramInt5, paramArrayOfDouble2, i3 - 1 + paramInt6, paramArrayOfDouble3, i3 - 1 + paramInt7, 1, 1, arrayOfDouble, 0, 1, paramArrayOfDouble5, paramInt12, paramInt13, localintW1);
              } else {
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/lapack/Dlaqr0.class
