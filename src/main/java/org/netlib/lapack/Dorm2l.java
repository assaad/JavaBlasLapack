...
public final class Dorm2l
{
  public static void dorm2l(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, double[] paramArrayOfDouble1, int paramInt4, int paramInt5, double[] paramArrayOfDouble2, int paramInt6, double[] paramArrayOfDouble3, int paramInt7, int paramInt8, double[] paramArrayOfDouble4, int paramInt9, intW paramintW)
  {
    ...
    {
      Xerbla.xerbla("DORM2L", -paramintW.val);
      return;
    }
    ...
    for (int i3 = (k - j + m) / m; i3 > 0; i3--)
    {
      ...
      d = paramArrayOfDouble1[(i2 - paramInt3 + i - 1 + (i - 1) * paramInt5 + paramInt4)];
      paramArrayOfDouble1[(i2 - paramInt3 + i - 1 + (i - 1) * paramInt5 + paramInt4)] = 1.0D;
      Dlarf.dlarf(paramString1, n, i1, paramArrayOfDouble1, 1 - 1 + (i - 1) * paramInt5 + paramInt4, 1, paramArrayOfDouble2[(i - 1 + paramInt6)], paramArrayOfDouble3, paramInt7, paramInt8, paramArrayOfDouble4, paramInt9);
      paramArrayOfDouble1[(i2 - paramInt3 + i - 1 + (i - 1) * paramInt5 + paramInt4)] = d;
      i += m;
    }
  }
}
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/lapack/Dorm2l.class
