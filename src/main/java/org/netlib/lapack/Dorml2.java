...
public final class Dorml2
{
  public static void dorml2(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, double[] paramArrayOfDouble1, int paramInt4, int paramInt5, double[] paramArrayOfDouble2, int paramInt6, double[] paramArrayOfDouble3, int paramInt7, int paramInt8, double[] paramArrayOfDouble4, int paramInt9, intW paramintW)
  {
    ...
    {
      Xerbla.xerbla("DORML2", -paramintW.val);
      return;
    }
    ...
    for (int i5 = (k - j + m) / m; i5 > 0; i5--)
    {
      ...
      Dlarf.dlarf(paramString1, i2, i3, paramArrayOfDouble1, i - 1 + (i - 1) * paramInt5 + paramInt4, paramInt5, paramArrayOfDouble2[(i - 1 + paramInt6)], paramArrayOfDouble3, n - 1 + (i1 - 1) * paramInt8 + paramInt7, paramInt8, paramArrayOfDouble4, paramInt9);
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/lapack/Dorml2.class
