...
public final class Dormql
{
  public static void dormql(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, double[] paramArrayOfDouble1, int paramInt4, int paramInt5, double[] paramArrayOfDouble2, int paramInt6, double[] paramArrayOfDouble3, int paramInt7, int paramInt8, double[] paramArrayOfDouble4, int paramInt9, int paramInt10, intW paramintW)
  {
    ...
    if ((paramintW.val != 0 ? 0 : 1) != 0)
    {
      ...
      {
        i6 = Math.min(64, Ilaenv.ilaenv(1, "DORMQL", paramString1 + paramString2, paramInt1, paramInt2, paramInt3, -1));
        i4 = i10 * i6;
      }
    ...
    if ((paramintW.val == 0 ? 0 : 1) != 0)
    {
      Xerbla.xerbla("DORMQL", -paramintW.val);
      return;
    }
    if (i != 0) {
      return;
    ...
    if (((i6 >= paramInt3 ? 0 : 1) != 0 ? 1 : 0) != 0)
    {
      ...
      {
        i6 = paramInt10 / i3;
        i7 = Math.max(2, Ilaenv.ilaenv(2, "DORMQL", paramString1 + paramString2, paramInt1, paramInt2, paramInt3, -1));
      }
    }
    else
    {
    ...
    {
      Dorm2l.dorm2l(paramString1, paramString2, paramInt1, paramInt2, paramInt3, paramArrayOfDouble1, paramInt4, paramInt5, paramArrayOfDouble2, paramInt6, paramArrayOfDouble3, paramInt7, paramInt8, paramArrayOfDouble4, paramInt9, localintW);
    }
    else
    {
      ...
      for (int i11 = (m - k + n) / n; i11 > 0; i11--)
      {
        ...
        Dlarft.dlarft("Backward", "Columnwise", i9 - paramInt3 + j + i1 - 1, i1, paramArrayOfDouble1, 1 - 1 + (j - 1) * paramInt5 + paramInt4, paramInt5, paramArrayOfDouble2, j - 1 + paramInt6, arrayOfDouble, 0, 65);
        if (bool1) {
          i5 = paramInt1 - paramInt3 + j + i1 - 1;
        } else {
          i8 = paramInt2 - paramInt3 + j + i1 - 1;
        }
        Dlarfb.dlarfb(paramString1, paramString2, "Backward", "Columnwise", i5, i8, i1, paramArrayOfDouble1, 1 - 1 + (j - 1) * paramInt5 + paramInt4, paramInt5, arrayOfDouble, 0, 65, paramArrayOfDouble3, paramInt7, paramInt8, paramArrayOfDouble4, paramInt9, i3);
        j += n;
      }
    }
    paramArrayOfDouble4[(1 - 1 + paramInt9)] = i4;
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/lapack/Dormql.class
