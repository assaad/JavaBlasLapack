...
public final class Dsyrfs
{
  public static void dsyrfs(String paramString, int paramInt1, int paramInt2, double[] paramArrayOfDouble1, int paramInt3, int paramInt4, double[] paramArrayOfDouble2, int paramInt5, int paramInt6, int[] paramArrayOfInt1, int paramInt7, double[] paramArrayOfDouble3, int paramInt8, int paramInt9, double[] paramArrayOfDouble4, int paramInt10, int paramInt11, double[] paramArrayOfDouble5, int paramInt12, double[] paramArrayOfDouble6, int paramInt13, double[] paramArrayOfDouble7, int paramInt14, int[] paramArrayOfInt2, int paramInt15, intW paramintW)
  {
    boolean bool = false;
    int i = 0;
    int j = 0;
    ...
    {
      Xerbla.xerbla("DSYRFS", -paramintW.val);
      return;
    }
    ...
    for (int i1 = paramInt2 - 1 + 1; i1 > 0; i1--)
    {
      ...
      for (;;)
      {
        ...
        Dsymv.dsymv(paramString, paramInt1, -1.0D, paramArrayOfDouble1, paramInt3, paramInt4, paramArrayOfDouble4, 1 - 1 + (k - 1) * paramInt11 + paramInt10, 1, 1.0D, paramArrayOfDouble7, paramInt1 + 1 - 1 + paramInt14, 1);
        j = 1;
        ...
        if (bool)
        {
          ...
          for (int i2 = paramInt1 - 1 + 1; i2 > 0; i2--)
          {
            ...
            paramArrayOfDouble7[(m - 1 + paramInt14)] = (paramArrayOfDouble7[(m - 1 + paramInt14)] + Math.abs(paramArrayOfDouble1[(m - 1 + (m - 1) * paramInt4 + paramInt3)]) * d7 + d3);
            m += 1;
          }
        }
        else
        {
          ...
          for (int i2 = paramInt1 - 1 + 1; i2 > 0; i2--)
          {
            d3 = 0.0D;
            d7 = Math.abs(paramArrayOfDouble4[(m - 1 + (k - 1) * paramInt11 + paramInt10)]);
            paramArrayOfDouble7[(m - 1 + paramInt14)] += Math.abs(paramArrayOfDouble1[(m - 1 + (m - 1) * paramInt4 + paramInt3)]) * d7;
            j = m + 1;
        ...
        Dsytrs.dsytrs(paramString, paramInt1, 1, paramArrayOfDouble2, paramInt5, paramInt6, paramArrayOfInt1, paramInt7, paramArrayOfDouble7, paramInt1 + 1 - 1 + paramInt14, paramInt1, paramintW);
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/lapack/Dsyrfs.class
