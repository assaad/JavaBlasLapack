  ...
  public static void sorm2l(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, float[] paramArrayOfFloat1, int paramInt4, int paramInt5, float[] paramArrayOfFloat2, int paramInt6, float[] paramArrayOfFloat3, int paramInt7, int paramInt8, float[] paramArrayOfFloat4, int paramInt9, intW paramintW)
  {
    ...
    else
    {
      ...
      if (((paramInt3 <= i2 ? 0 : 1) == 0 ? 0 : 1) != 0) {
        paramintW.val = -5;
      } else if ((paramInt5 >= Math.max(1, i2) ? 0 : 1) != 0) {
        paramintW.val = -7;
    ...
    {
      Xerbla.xerbla("SORM2L", -paramintW.val);
      return;
    }
    ...
    for (int i3 = (k - j + m) / m; i3 > 0; i3--)
    {
      ...
      f = paramArrayOfFloat1[(i2 - paramInt3 + i - 1 + (i - 1) * paramInt5 + paramInt4)];
      paramArrayOfFloat1[(i2 - paramInt3 + i - 1 + (i - 1) * paramInt5 + paramInt4)] = 1.0F;
      Slarf.slarf(paramString1, n, i1, paramArrayOfFloat1, 1 - 1 + (i - 1) * paramInt5 + paramInt4, 1, paramArrayOfFloat2[(i - 1 + paramInt6)], paramArrayOfFloat3, paramInt7, paramInt8, paramArrayOfFloat4, paramInt9);
      paramArrayOfFloat1[(i2 - paramInt3 + i - 1 + (i - 1) * paramInt5 + paramInt4)] = f;
      i += m;
    }
  }
}
...
/* Location:              /Users/assaad/Downloads/arpack_combined_all/!/org/netlib/lapack/Sorm2l.class
